...
def convert_create_ml_to_yolo(labels, image_dir, parent_dir):
    ...
    for line in urllib.request.urlopen(
        'https://github.com/mojulian/ultralytics/releases/download/0.1/train_images.txt'
    ):
...
if __name__ == '__main__':
    ...
    parser.add_argument(
        '--images-dir',
        default='../../datasets/CARPK_devkit/data/Images',
        help='Path to the images directory in the CARPK dataset',
    )
    parser.add_argument(
        '--labels-dir',
        default='../../datasets/CARPK_devkit/data/Annotations',
        help='Path to the labels directory in the CARPK dataset',
    )
    parser.add_argument(
        '--new-data-dir', default='../../datasets/CARPK', help='Path to the new data directory in the YOLO format'
    )
